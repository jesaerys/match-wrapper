    ...
    if writesfh or writezcb:
        ...
        for n, sfhtext in enumerate(sfhtext_list):
            ...
            if writezcb:
                ...
                cmd = 'zcombine {0:s} -bestonly > {1:s}'.format(sfh, zcb)
...
def main():
    ...
    """
    hmcfile = '/absolute/path/to/hybridMC/file'
    sfhfile = '/absolute/path/to/sfh/file/myfile_{0:0{1}d}.sfh'
    zcbfile = '/absolute/path/to/zcb/file/myfile_{0:0{1}d}.zcb'
